\documentclass[../skript.tex]{subfiles}
 ...
 \section{Well-posedness of the scattering problem in bounded domains}\label{c2se2}
 	...
 	\[
 		\|\cdot\|_\kappa \coloneqq \sqrt{\|\nabla\cdot\|_{L^2(\Omega)}^2+\kappa^2\|n^\frac{1}{2}\cdot\|_{L^2(\Omega)}^2},
 	\]
 	...
 	\[
 		\underbrace{\re a(u,u) + 2\kappa^2 \|n^\frac{1}{2}u\|_{L^2(\Omega)}^2 = \|u\|_\kappa^2,\quad\forall u\in H^1(\Omega).}_{\text{'Garding's inequality}}
 	\]
